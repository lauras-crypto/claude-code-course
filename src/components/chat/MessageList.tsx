...
export function MessageList({ messages, isLoading }: MessageListProps) {
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-[calc(100vh-10rem)] px-4 text-center">
        <div className="rounded-xl border border-neutral-200 bg-white shadow-sm p-6 max-w-sm w-full">
          <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-blue-50 mb-4 shadow-sm mx-auto">
            <Bot className="h-7 w-7 text-blue-600" />
          </div>
          <h2 className="text-neutral-900 font-semibold text-lg mb-2">Start a conversation to generate React components</h2>
